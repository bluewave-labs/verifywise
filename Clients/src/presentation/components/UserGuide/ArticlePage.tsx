...
import { ChevronLeft, ChevronRight, Rocket, Shield, AlertTriangle, Brain, Settings, Plug, FileText, GraduationCap, BarChart3, FlaskConical, ScanSearch, LucideIcon } from 'lucide-react';
