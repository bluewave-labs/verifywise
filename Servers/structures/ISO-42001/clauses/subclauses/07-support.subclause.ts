...
export const Support: Partial<SubClauseStructISO & SubClauseISO>[] = [
  {
    ...
    implementation_description: "Resources required for AIMS, including staff, technology, and tools, are identified during annual budgeting and project planning processes.",
    auditor_feedback: "Resource planning is adequate. Recommend conducting periodic reviews to ensure AI projects are not under-resourced mid-cycle."
  },
  {
    title: "Competence",
    order_no: 2,
    ...
    implementation_description: "Competency requirements are defined in job descriptions; staff are trained through internal and external AI-specific programs.",
    auditor_feedback: "Competency documentation is robust. Suggest more structured refresher training schedules to maintain AI literacy over time."
  },
  {
    title: "Awareness",
    order_no: 3,
    ...
    implementation_description: "Awareness of AI policy and individual responsibilities is maintained through onboarding, quarterly updates, and mandatory e-learning modules.",
    auditor_feedback: "Awareness efforts are well-documented. Consider adding scenario-based training to improve practical understanding of ethical implications."
  },
  {
    title: "Communication",
    order_no: 4,
    ...
    implementation_description: "A communication matrix guides internal/external AIMS-related messaging, including roles, frequency, and channels.",
    auditor_feedback: "Communication mechanisms are clearly defined. Future audits should validate consistency of execution across departments."
  },
  {
    title: "Documented information",
    order_no: 5,
    summary: "Manage documented information required by the standard and necessary for AIMS effectiveness (creation, update, control, availability, protection).",
    questions: [
    ...
    implementation_description: "Document control follows a formal procedure ensuring versioning, access control, and periodic review. A master document register is maintained.",
    auditor_feedback: "Strong document management observed. Ensure all legacy AI documentation is migrated and version-controlled accordingly."
  }
]