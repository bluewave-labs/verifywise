// vendorRiskMockData.ts

/**
 * for the risk level the values are: No risk, Low risk, Medium risk, High risk, Very high risk
 *
 */

// Define the type for VendorRisk based on the table structure
type VendorRisk = {
  id: number;
