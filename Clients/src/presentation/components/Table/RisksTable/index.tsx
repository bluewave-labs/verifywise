              ...
              >
                ...
                <TableCell
                  sx={{
                    ...getCellStyle(row),
                    backgroundColor:
                      sortConfig.key === "vendor_name" ? theme.palette.background.hover : "inherit",
                  }}
                >
                  {
                ...
                <TableCell
                  sx={{
                    ...getCellStyle(row),
                    backgroundColor:
                      sortConfig.key === "action_owner" ? theme.palette.background.hover : "inherit",
                  }}
                >
                  {
                    formattedUsers?.find(
                ...
                <TableCell
                  sx={{
                    ...getCellStyle(row),
                    backgroundColor:
                      sortConfig.key === "risk_level" ? theme.palette.background.hover : "inherit",
                  }}
                >
                  <VWLink
                    onClick={(e) => {
