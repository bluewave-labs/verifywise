...
export const AISystemLifecycle: Partial<AnnexCategoryStructISO & AnnexCategoryISO>[] = [
  {
    ...
    is_applicable: true,
    implementation_description: "Lifecycle stages are documented and controlled from conception to retirement.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Requirements cover functional, ethical, and legal aspects per organizational standards.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "System design documents include architecture, data flow, and interaction mechanisms.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Data acquisition processes ensure quality and ethical sourcing with proper pre-processing.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Models undergo rigorous training, tuning, and evaluation against defined metrics.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Verification and validation activities are formalized before deployment.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Deployment procedures ensure controlled rollout and rollback capabilities.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Monitoring includes performance, anomaly detection, and compliance checks.",
