...
router.get("/annexes/struct/byProjectId/:id", authenticateJWT, validateId("id"), getAllAnnexesStructForProject);
...
router.get("/annexControls/byAnnexId/:id", authenticateJWT, validateId("id"), getAnnexControlsByAnnexId);

router.get("/subClause/byId/:id", authenticateJWT, validateId("id"), validateId("projectFrameworkId"), getSubClauseById);
router.get("/annexControl/byId/:id", authenticateJWT, validateId("id"), validateId("projectFrameworkId"), getAnnexControlById);
