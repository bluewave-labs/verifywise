 ...
 */
export const validateUpdateAnnexCategory = (data: any): ValidationError[] => {
  const errors = validateSchema(data, updateAnnexCategorySchema);
...
export const validateCompleteAnnexCategoryUpdate = (data: any, files?: any[]): ValidationError[] => {
  const errors = validateUpdateAnnexCategory(data);
