...
import EvidentlyManagement from "../../presentation/pages/Integrations/EvidentlyManagement";
...
export const createRoutes = (
  ...
  >
    ...
    <Route path="/integrations/evidently" element={<EvidentlyManagement />} />
    ...
    <Route path="/model-inventory/evidently-data" element={<ModelInventory />} />
