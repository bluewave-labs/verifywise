...
export const ThirdPartyRelationships: Partial<AnnexCategoryStructISO & AnnexCategoryISO>[] = [
  {
    ...
    guidance: "Risks associated with third-party provision or use of AI systems, components, services, or data should be identified, assessed, and managed through appropriate agreements and monitoring.",
    is_applicable: true,
    implementation_description: "Third-party AI risks assessed and mitigated through contractual and monitoring processes.",
  ...
  },
  {
    ...
    guidance: "Agreements with third parties supplying AI systems, components, services, or data should include relevant AI-specific requirements (e.g., security, privacy, ethics, performance).",
    is_applicable: true,
    implementation_description: "Supplier contracts include AI-specific clauses on security, privacy, and performance.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Regular performance and compliance reviews of third-party AI service providers conducted.",
