...
const MappingSection = ({ title, items, type, isLoading }: any) => {
  ...
  return (
    <Stack spacing={1} mb={4}>
      ...
      <Stack direction="row" spacing={1} flexWrap="wrap" columnGap={2} rowGap={1}>
...
const TaskDetails: React.FC = () => {
  ...
  const mappedNames = useMemo(() => {
    ...
    return {
      ...
      frameworks: mapIdsToNames((task as any).frameworks, "frameworkMap"),
      vendors: mapIdsToNames((task as any).vendors, "vendorMap"),
    };
  }, [task, mapIdsToNames]);
      ...
      try {
        ...
        const updatePayload = {
          ...
          assignees: formData.assignees.map((assignee: any) =>
            typeof assignee === "object" && "id" in assignee ? assignee.id : assignee
          ),
        };
          ...
          <CardContent sx={{ p: 0 }}>
            ...
            >
              <Stack direction="row" justifyContent="space-between" spacing="16px">
                <Button variant="outlined" size="small" onClick={handleBackClick}>
                  Back to tasks
                </Button>
                <Button
                  variant="contained"
            ...
            <Box sx={{ px: "24px", py: "24px" }}>
              <Stack spacing="24px">
                ...
                <Stack direction="row" sx={{ py: "12px", gap: "16px" }}>
                  ...
                  <Chip sx={getChipStyle("status", task.status)} label={task.status} size="small" />
                </Stack>
                ...
                <Stack direction="row" sx={{ py: "12px", gap: "16px" }}>
                  ...
                  <Chip label={task.priority} sx={getChipStyle("priority", task.priority)} />
                </Stack>
                ...
                <Stack direction="row" sx={{ py: "16px", gap: "16px" }}>
                  ...
                  >
                    {task.due_date ? dayjs(task.due_date).format("DD MMMM YYYY") : "-"}
                  </Typography>
                </Stack>
                ...
                {/* DESCRIPTION */}
                <Stack direction="row" alignItems="flex-start" sx={{ py: "12px", gap: "24px" }}>
                  <Typography
                    sx={{
                      fontSize: 13,
                      fontWeight: 600,
          ...
          <CardContent sx={{ p: 0 }}>
            ...
            >
              <Stack direction="row" justifyContent="flex-end" spacing="16px">
                <Button variant="contained" size="small" onClick={handleEditMappingsClick}>
                  Edit mappings
                </Button>
              </Stack>
            </Box>
