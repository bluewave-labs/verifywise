...
export const ICT: Partial<AnnexCategoryStructISO & AnnexCategoryISO>[] = [
  {
    ...
    is_applicable: true,
    implementation_description: "Information security policies based on ISO/IEC 27001 protect AI systems throughout lifecycle.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "AI models are protected with access controls, encryption, and integrity checks.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Data security policies ensure protection according to classification and organizational standards.",
  ...
  },
  {
    ...
    is_applicable: false,
    "justification_for_exclusion": "Current AI deployments are limited and do not yet require advanced resilience measures.",
    implementation_description: "",
    auditor_feedback: "Recommend planning for resilience as AI footprint expands."
  }
]