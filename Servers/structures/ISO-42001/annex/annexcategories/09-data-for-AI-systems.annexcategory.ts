...
export const DataForAISystems: Partial<AnnexCategoryStructISO & AnnexCategoryISO>[] = [
  {
    ...
    is_applicable: true,
    implementation_description: "Processes ensure data accuracy, completeness, and timeliness aligned with AI use cases.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Data acquisition complies with legal and ethical standards with documented approval.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Data is cleaned, annotated, and transformed per model requirements.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Automated lineage tracking tools document data origin and transformation steps.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Privacy controls include anonymization and pseudonymization compliant with GDPR.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Data is securely stored, accessed, transmitted, and disposed per classification.",
