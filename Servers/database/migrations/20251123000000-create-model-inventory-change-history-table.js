...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      if (!tableExists[0].exists) {
        console.log('Organizations table does not exist yet. Skipping model inventory change history table creation.');
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      // If organizations table doesn't exist, skip migration
      if (!tableExists[0].exists) {
        console.log('Organizations table does not exist yet. Skipping model inventory change history table rollback.');
        await transaction.commit();
        return;
      }
