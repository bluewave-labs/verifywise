...
export default function BiasAndFairnessResultsPage() {
  ...
  const getSpecializedMetricDescription = useCallback(
    (metric: string, attribute: "sex" | "race"): string => {
  ...
  const handleDownloadJSON = useCallback(() => {
    try {
      ...
      const errorMessage = `Failed to download JSON: ${
  ...
  const handleSaveConfig = async () => {
    ...
    try {
      ...
      await biasAndFairnessService.updateEvaluationConfig(
        metrics.eval_id,
        configObj
      );
                ...
                <Box>
                                ...
                                data={[
                                  {
                                    ...
                                    marker: {
                                      color: Object.values(sexMetrics).map(
                                        (v) => {
                                          const numValue =
                                            typeof v === "number" ? v : 0;
                            ...
                            <Stack spacing={2}>
                              {Object.keys(sexMetrics).map((metric) => (
                                ...
                                >
                                  ...
                                  >
                                    {getSpecializedMetricDescription(
                                      metric,
                                      "sex"
                                    )}
                                  </Typography>
                  ...
                  >
                    ...
                    >
                      ...
                      {FAIRNESS_THRESHOLD_SIGNIFICANT}), and red shows
                      significant bias (&gt;{FAIRNESS_THRESHOLD_SIGNIFICANT}).
                    </Typography>
                  </Box>
                                ...
                                data={[
                                  {
                                    ...
                                    marker: {
                                      color: Object.values(raceMetrics).map(
                                        (v) => {
                                          const numValue =
                                            typeof v === "number" ? v : 0;
                                          return Math.abs(numValue) >
            ...
            <Box>
              ...
              >
                <Typography variant="body2" sx={{ color: "#6b7280" }}>
                  Select metrics to include/exclude on the Plots & Graphs.
                </Typography>
                <CustomizableButton
                  variant="contained"
                      ...
                      <>
                        ...
                        <Button
                          ...
                          sx={{
                            textTransform: "none",
                            background:
                              "linear-gradient(135deg, #13715B 0%, #0F5A4A 100%)",
                            color: "white",
                            fontWeight: 500,
                            fontSize: "13px",
                            height: "36px",
                    ...
                    >
                      <Editor
                        ...
                        options={{
                          ...
                          fontSize: 13,
                          lineNumbers: "on",
                          renderLineHighlight: isConfigEditMode
                            ? "all"
                            : "none",
                          scrollbar: {
                            vertical: "auto",
          ...
          <TabPanel value="visualizations" sx={{ ...tabPanelStyle, pt: 2 }}>
            <Stack spacing={4}>
              <Box>
                ...
                <Typography
                  variant="body2"
                  sx={{ mb: 4, color: COLORS.TEXT_SECONDARY }}
                >
                  Explore comprehensive visual analysis of fairness metrics
                  across different dimensions.
                  <br />
                  <br />
                  <strong>Note:</strong> Advanced visualizations require raw
                  prediction data from the evaluation. These visualizations will
                  be automatically generated when the complete evaluation data
                  is available. Each visualization provides unique insights into
                  different aspects of fairness and bias in your model.
                </Typography>
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    <Typography
                      variant="h3"
                      sx={{ mb: 2, ...STYLES.subsectionTitle }}
                    >
                      Demographic Parity Analysis
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Measures how equally outcomes are distributed across
                      groups. Lower values indicate fairer distribution.
                    </Typography>
                    <Box sx={{ height: 500 }}>
                      {Plot ? (
                        <Plot
                          data={[
                            {
                              ...
                              text: [
                                ...
                                (raceMetrics.demographic_parity || 0).toFixed(
                                  4
                                ),
                              ],
                              textposition: "outside",
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Side-by-side comparison of all fairness metrics across sex
                      and race attributes.
                    </Typography>
                    <Box sx={{ height: 600 }}>
                      {Plot ? (
                          ...
                          layout={{
                            ...
                            yaxis: {
                              ...
                              range: [
                                ...
                                Math.max(
                                  Math.max(
                                    ...Object.values(sexMetrics).map(Math.abs)
                                  ),
                                  Math.max(
                                    ...Object.values(raceMetrics).map(Math.abs)
                                  )
                                ) + 0.05,
                              ],
                            },
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Compares predicted probabilities against actual outcomes
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Side-by-side confusion matrices for each demographic group
                      to compare prediction patterns.
                    </Typography>
                    <Box sx={{ height: 500 }}>
                      {Plot ? (
                        <Plot
                          data={[
                            {
                              ...
                              z: [
                                [
                                  Math.round(
                                    (performance.accuracy || 0.5) * 100
                                  ),
                                  Math.round(
                                    (1 - (performance.accuracy || 0.5)) * 100
                                  ),
                                ],
                                [
                                  Math.round(
                              ...
                              texttemplate: "%{text}",
                              hovertemplate:
                                "True: %{y}<br>Pred: %{x}<br>Count: %{text}<extra></extra>",
                              name: "Sex Group",
                            },
                          ]}
                          layout={{
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Compares model accuracy with fairness metrics across
                          ...
                          data={[
                            {
                              ...
                              text: [
                                ...
                                ).toFixed(3)}<br>EO Diff: ${(
                                  sexMetrics.equalized_odds || 0
                                ).toFixed(4)}`,
                              ],
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Multi-dimensional view of fairness metrics across groups
                      for holistic comparison.
                    </Typography>
                    <Box sx={{ height: 500 }}>
                      {Plot ? (
                        <Plot
                          data={[
                            ...
                            },
                            {
                              ...
                              r: [
                                ...
                                Math.abs(
                                  raceMetrics.equalized_opportunity || 0
                                ),
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Heatmap showing selection rates by group within different
                      strata defined by legitimate attributes.
                    </Typography>
                    <Box sx={{ height: 500 }}>
                      {Plot ? (
                        <Plot
                          data={[
                            {
                              ...
                              text: [
                                [
                                  (sexMetrics.demographic_parity || 0).toFixed(
                                    3
                                  ),
                                  (sexMetrics.equalized_odds || 0).toFixed(3),
                                  (sexMetrics.predictive_parity || 0).toFixed(
                                    3
                                  ),
                                ],
                                [
                                  ...
                                  (raceMetrics.predictive_parity || 0).toFixed(
                                    3
                                  ),
                                ],
                              ],
                              texttemplate: "%{text}",
                              hovertemplate:
                                "Group: %{y}<br>Metric: %{x}<br>Value: %{text}<extra></extra>",
                            },
                          ]}
                          layout={{
                            width: "100%",
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Stacked horizontal bar chart showing cumulative fairness
                      metrics (TPR, PPV, FPR, ACC, SPR) per subgroup.
                    </Typography>
                    <Box sx={{ height: 500 }}>
                      {Plot ? (
                        <Plot
                          data={[
                            {
                              ...
                              text: [
                                ...
                                (sexMetrics.equalized_opportunity || 0).toFixed(
                                  3
                                ),
                                (sexMetrics.predictive_equality || 0).toFixed(
                                  3
                                ),
                              ],
                              textposition: "outside",
                            },
                            {
                              ...
                              text: [
                                ...
                                (raceMetrics.predictive_equality || 0).toFixed(
                                  3
                                ),
                              ],
                              textposition: "outside",
                ...
                <Box mb={6}>
                  <Paper elevation={0} sx={{ p: 3, ...STYLES.paper }}>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 3, color: COLORS.TEXT_SECONDARY }}
                    >
                      Boxplots showing distribution of key fairness metrics
                      (TPR, FPR, PPV, NPV) across demographic groups.
                    </Typography>
                    <Box sx={{ height: 500 }}>
                      {Plot ? (
                        <Plot
                          ...
                          layout={{
                            ...
                            margin: { t: 40, b: 60, l: 80, r: 40 },
                            title:
                              "Fairness Metrics Distribution Across Groups",
                            xaxis: { title: "Fairness Metrics" },
