...
const AddNewRiskForm: FC = () => {
    ...
    const riskTabRender = () => {
        return (
            <Stack>
                ...
                />
                <Divider />
                <Typography>Calculate risk level</Typography>
                <Typography>The Risk Level is calculated by multiplying the Likelihood and Severity scores. By assigning these scores, the risk level will be determined based on your inputs.</Typography>
                <Select
                    id="likelihood-input"
                    label="Likelihood"
    ...
    return (
        <Stack
            component="form"
            noValidate
            sx={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", columnGap: "26px", rowGap: "17px" }}
        >
