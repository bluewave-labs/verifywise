...
const FEATURE_TOOLTIPS: Record<string, string> = {
  ...
  'Model inventory and risks': 'Complete catalog of all AI models with detailed risk profiles, performance metrics, and lifecycle management.',
  ...
  'Starter': {
    ...
    features: {
      ...
      'AI Governance Features': {
        ...
        'Model inventory and risks': true,
        'Tasks': true,
                    ...
                    <React.Fragment key={category}>
                      ...
                      <TableRow sx={{ bgcolor: 'grey.50' }}>
                        <TableCell colSpan={allTiers.filter(tier => tier.name !== 'Team').length + 1} sx={{ py: 2, borderBottom: 1, borderColor: 'grey.200' }}>
                          <Typography variant="h6" fontWeight="semibold" color="success.main" sx={{ fontSize: '15px', textTransform: 'uppercase' }}>
                            {category}
                          </Typography>
                        </TableCell>
                      </TableRow>
