...
export const InternalOrganization: Partial<AnnexCategoryStructISO & AnnexCategoryISO>[] = [
  {
    ...
    is_applicable: true,
    implementation_description: "Internal roles for AI development, deployment, and governance are clearly defined.",
  ...
  },
  {
    ...
    guidance: "Conflicting duties and areas of responsibility should be segregated to reduce opportunities for unauthorized or unintentional modification or misuse of AI systems or related assets.",
    is_applicable: true,
    implementation_description: "Segregation implemented to reduce risks of unauthorized AI system modifications.",
