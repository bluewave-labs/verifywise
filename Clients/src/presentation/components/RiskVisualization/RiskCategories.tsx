  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h6" sx={{ fontWeight: 600, color: '#111827', display: 'flex', alignItems: 'center', gap: 1 }}>
          <CategoryIcon sx={{ fontSize: 18, color: '#13715B' }} />
                    ...
                    <Box sx={{ flex: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Chip
                          ...
                          sx={{
                            backgroundColor: `${criticalLevel.color}20`,
                            color: criticalLevel.color,
                            fontWeight: 600,
                            fontSize: 11,
                            height: 20,
                            minWidth: 20,
