...
// Mock TagChip component - mimics the real component for documentation purposes
const MockTagChip: React.FC<{ tag: string }> = ({ tag }) => {
  // Tag color mapping based on the real component's getTagStyle function
  const getTagStyle = (tagName: string) => {
    ...
    return tagStyles[normalizedTag] || { bg: "#F5F5F5", color: "#616161" };
  };
        ...
        <Box sx={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
          <Box sx={{ flex: "1 1 500px", minWidth: 320 }}>
            <Stack spacing="24px">
              ...
              >
                <Box sx={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                  <MockTagChip tag="Privacy" />
                  <MockTagChip tag="Security" />
                  <MockTagChip tag="EU AI Act" />
                  <MockTagChip tag="LLM" />
                </Box>
              </ExampleWithCode>
              ...
              >
                <Box sx={{ display: "flex", gap: "8px" }}>
                  <MockTagChip tag="Custom Tag" />
                  <MockTagChip tag="Unknown" />
                </Box>
              </ExampleWithCode>
            </Stack>
          </Box>
