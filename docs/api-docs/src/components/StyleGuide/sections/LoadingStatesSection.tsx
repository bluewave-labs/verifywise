...
import { Box, Stack, Typography, useTheme, Divider, Snackbar, Skeleton, CircularProgress, SxProps, Theme } from "@mui/material";
import { Copy } from "lucide-react";
import CodeBlock from "../CodeBlock";

// MockSkeleton: Inline component that mimics CustomizableSkeleton behavior
// Supports text, rectangular, circular, and rounded variants with customizable dimensions
...
const MockSkeleton: React.FC<MockSkeletonProps> = ({
  variant = "text",
  width,
  height,
  maxWidth,
        ...
        <Box sx={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
          <Box sx={{ flex: "1 1 500px", minWidth: 320 }}>
            <Stack spacing="24px">
              ...
              >
                <Stack spacing="8px">
                  <MockSkeleton variant="text" width={200} />
                  <MockSkeleton variant="rectangular" width={200} height={40} />
                </Stack>
              </ExampleWithCode>
            </Stack>
          </Box>
