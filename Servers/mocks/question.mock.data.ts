...
export const questions = (
  ...
  return [
    ...
    },
    {
      order_no: 4,
      subtopic_id: subTopics[1],
      question: "Add technology documentation. You can include a data flow diagram, MLops lifecycle diagram. Think of it as an executive summary of the technology you are using.",
    ...
    },
    {
      ...
      question: "Will you make substantial modifications to the high-risk AI system already on the EU market, and if so, what additional training or fine-tuning will be performed on the model after these modifications?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[2],
      question: "What business problem does the AI system solve, and what are its capabilities? What other techniques were considered before deciding to use AI to address this problem?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[2],
      question: "How has your organization assessed the AI application against its ethical values? What ethical considerations were most pertinent, and how were they addressed?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[3],
      question: "What risks were identified in the data impact assessment? How have these risks been addressed or mitigated?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[3],
      question: "How has the selection or development of the model been assessed with regard to fairness, explainability, and robustness? What specific risks were identified in this assessment?",
    ...
    },
    {
      order_no: 4,
      subtopic_id: subTopics[3],
      question: "What strategies have been implemented to address the risks identified in the model assessment? How effective have these strategies been?",
    ...
    },
    {
      ...
      question: "What risks have been identified associated with the chosen deployment and serving strategies? How have these risks been prioritized?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[4],
      question: "What measures are in place to detect undesired behavior in our AI solution, including logging and responding to such behavior?",
    ...
    },
    {
      order_no: 4,
      subtopic_id: subTopics[4],
      question: "What is the possible harmful effect of uncertainty and error margins for different groups? How is this being addressed?",
    ...
    },
    {
      order_no: 5,
      subtopic_id: subTopics[4],
      question: "What mechanisms are in place for reporting serious incidents and certain risks to both the relevant authorities and other stakeholders?",
    ...
    },
    {
      order_no: 6,
      subtopic_id: subTopics[4],
      question: "What risks have been identified associated with potentially decommissioning the AI system? How might these risks impact users, the organization, or other stakeholders?",
    ...
    },
    {
      order_no: 7,
      subtopic_id: subTopics[4],
      question: "What data sources are being used to develop the AI application? Describe the input and output data, and explain how this data is documented and managed.",
    ...
    },
    {
      order_no: 8,
      subtopic_id: subTopics[4],
      question: "Does the repository track and manage intellectual property rights and restrictions on the use of its content as required by deposit agreements, contracts, or licenses?",
    ...
    },
    {
      ...
      question: "How has your organization ensured the representativeness, relevance, accuracy, traceability, and completeness of the data used in development? What challenges were encountered in this process?",
      hint: "Explain the origins of the training dataset, its attributes, data types, categories, IP rights, and volume. Include metadata and data collection processes, such as web scraping or surveys. Detail the IP rights of the datasets, demonstrating lawful use of training data.",
      priority_level: "medium priority",
      answer_type: "Long text",
      input_type: "Tiptap area",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[5],
      question: "Provide details of the confidential and sensitive data processed by the AI system. Does it handle personal data?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[5],
      question: "What are the legal bases for processing personal and sensitive data? What measures are in place to ensure that the processing logic remains consistent with the original purpose for which consent was obtained, and that data is deleted after the stipulated period?",
      hint: "Detail the datasets processed, specifying the sensitive and personal data involved, how they are collected, and the purposes of processing.",
      priority_level: "high priority",
      answer_type: "Long text",
      input_type: "Tiptap area",
    ...
    },
    {
      order_no: 4,
      subtopic_id: subTopics[5],
      question: "Describe the measures in place to ensure that the AI system does not leak private or sensitive data, especially in the context of adversarial attacks.",
    ...
    },
    {
      order_no: 5,
      subtopic_id: subTopics[5],
      question: "How has legal compliance with respect to data protection (e.g., GDPR) been assessed and ensured? What protected attributes have been identified and how are they handled?",
    ...
    },
    {
      order_no: 6,
      subtopic_id: subTopics[5],
      question: "Provide details of the measures in place to comply with data subject requests, including those related to access, objection, deletion, and other rights.",
    ...
    },
    {
      order_no: 7,
      subtopic_id: subTopics[5],
      question: "Has the organization determined how the privacy of those involved is protected? What specific measures are in place?",
    ...
    },
    {
      ...
      question: "What is the source of the model being used? If it''s a pre-existing model, how was it selected? If it''s being developed in-house, what was the development process?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[6],
      question: "What is your strategy for validating the model? How does this strategy ensure the model meets its intended purposes while minimizing unintended consequences?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[6],
      question: "How is your organization documenting AI performance in the training environment? What metrics are being used, and how do they relate to the agreed objectives?",
    ...
    },
    {
      ...
      question: "What performance criteria have been established for the AI application? How were these criteria determined, and how do they relate to the application''s objectives?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[7],
      question: "Describe the policies and procedures in place for retaining automatically generated logs for a minimum of six months to ensure adequate data tracking and auditability.",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[7],
      question: "How has your organization tested the model''s performance on extreme values and protected attributes? What were the results of these tests, and how have they informed further development?",
    ...
    },
    {
      order_no: 4,
      subtopic_id: subTopics[7],
      question: "What patterns of failure have been identified in the model? How were these patterns discovered, and what do they reveal about the model''s limitations?",
    ...
    },
    {
      ...
      question: "How is the supervision of the AI system designed to ensure human oversight wherever the AI solution could take or influence key decisions?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[9],
      question: "How is the effectiveness of human oversight ensured, including having sufficient knowledge to interpret the system’s outputs, understand automation bias, and mitigate fundamental risks?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[9],
      question: "What is your organization''s strategy for conducting periodic reviews of the AI application with regard to ethical values? Who will be involved in these reviews?",
    ...
    },
    {
      ...
      question: "How is human oversight empowered to stop or alter the AI system’s operations, ensuring the ability to intervene throughout its lifecycle and mitigate fundamental rights risks?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[10],
      question: "To what extent is human deliberation replaced by automated systems in this AI application?",
    ...
    },
    {
      ...
      question: "What is your strategy for testing the model? How does this strategy differ from the validation strategy, and why?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[11],
      question: "How will the AI system be served to end-users? What considerations have been made to ensure accessibility, reliability, and security?",
    ...
    },
    {
      ...
      question: "What monitoring systems will be in place to track the AI system''s performance in the production environment? How will this data be used to maintain or improve the system?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[12],
      question: "Are the details of the cloud provider and secure deployment architecture clearly defined, and what specific measures have been taken to address AI system security risks, including jailbreaks, and adversarial attacks?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[12],
      question: "How will your organization detect and address risks associated with changing data quality, potential data drift, and model decay? What thresholds have been set to trigger intervention?",
    ...
    },
    {
      ...
      question: "How has your organization defined and documented the set of values that guide the development and deployment of AI systems? Who is responsible for overseeing these values?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[13],
      question: "What governance framework has your organization implemented for AI projects? How does this framework ensure and demonstrate adherence to organizational values in practice?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[13],
      question: "Internal regular schedule of self-assessment and certification and, if certified, commits to notifying certifying bodies of operational changes that will change or nullify its certification status",
    ...
    },
    {
      ...
      question: "What processes have been established for users of the AI system to raise concerns or suggest improvements? How will this feedback be incorporated into the system''s development?",
      ...
      evidence_files: [],
      dropdown_options: [],
      answer: "Users can submit concerns or suggestions through a dedicated feedback portal accessible within the AI system interface. The feedback is reviewed by a product team that categorizes the issues based on severity and importance. High-priority suggestions or issues are escalated to the development team for prompt resolution. Continuous feedback cycles help in identifying improvements that are incorporated into system updates."
    },
    {
      order_no: 2,
      subtopic_id: subTopics[14],
      question: "What is your organization''s problem-to-resolution process for issues that arise with the AI system? How are problems prioritized and addressed?",
      ...
      evidence_files: [],
      dropdown_options: [],
      answer: "The problem-to-resolution process involves a multi-step procedure. Initially, issues are logged into a tracking system with detailed descriptions and classifications. Problems are prioritized based on urgency and impact, with critical issues being handled within 24 hours. The AI system’s engineering team performs root cause analysis, and fixes are developed, tested, and deployed. Post-resolution, a review is conducted to ensure the issue has been fully addressed and that no new issues were introduced."
    },
    {
      order_no: 3,
      subtopic_id: subTopics[14],
      question: "How will your organization update the AI application on an ongoing basis? What processes are in place to ensure these updates maintain or improve the system''s performance and compliance?",
      ...
      evidence_files: [],
      dropdown_options: [],
      answer: "Ongoing updates to the AI application are planned and scheduled quarterly, with emergency patches deployed as needed. Updates include performance improvements, bug fixes, and compliance enhancements. A testing environment simulates real-world conditions to verify the effectiveness of the changes. After each update, the system undergoes compliance checks to ensure alignment with relevant regulations and standards. Feedback from users and monitoring systems help in prioritizing these updates."
    },
    {
      order_no: 1,
      subtopic_id: subTopics[15],
      question: "What measures have been undertaken to address bias in the AI system''s training data, and what guardrails are in place to ensure non-discriminatory responses?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[15],
      question: "Are there specific groups that are favored or disadvantaged in the context where the AI application is used? How has this been assessed and addressed?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[15],
      question: "Is your user base comprised of individuals or groups from vulnerable populations? If so, what special considerations or protections have been put in place?",
    ...
    },
    {
      ...
      question: "Who in your organization is responsible for ensuring and demonstrating that AI systems adhere to defined organizational values? How is this responsibility carried out?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[16],
      question: "Are the inputs and outputs of the AI system logged, and what is the frequency of feedback and review? How long would it take to respond to and address any undesired behavior?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[16],
      question: "To what extent does the deployment of AI influence legal certainty and civil liberties? Is this influence clear to end users, stakeholders, and (popular) representatives?",
    ...
    },
    {
      order_no: 4,
      subtopic_id: subTopics[16],
      question: "What strategies has your organization developed to address the risks associated with decommissioning the AI system? How will data residuals, model accessibility, and interfaces to other systems be handled?",
    ...
    },
    {
      ...
      question: "What are the primary objectives of your AI application? How do these objectives align with your organization''s overall mission and values?",
    ...
    },
    {
      order_no: 2,
      subtopic_id: subTopics[17],
      question: "Provide the high-level business process logic of the AI system. Is it possible to explain the inner workings of the AI system to the end-user by linking specific responses to the source data or documents? Outline any Explainable AI (XAI) model used, with respect to both local and global explainability.",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[17],
      question: "To what extent can the operation of the application/algorithm be explained to end users and those involved?",
    ...
    },
    {
      ...
      question: "How has your organization assessed the overall environmental impact of this AI application? What factors were considered in this assessment?",
    ...
    },
    {
      order_no: 3,
      subtopic_id: subTopics[18],
      question: "What are the environmental effects of the AI application? How are these effects measured and mitigated?",
