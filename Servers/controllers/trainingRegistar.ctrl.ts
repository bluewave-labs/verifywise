...
export async function getTrainingRegistarById(req: Request, res: Response): Promise<any> {
  try {
    ...
    const trainingRegistar = await getTrainingRegistarByIdQuery(trainingRegistarId);
...
export async function createNewTrainingRegistar(req: Request, res: Response): Promise<any>{
    ...
    try{
        ...
        const createdNewTrainingRegistar = await createNewTrainingRegistarQuery(newTrainingRegistar, transaction);
...
export async function updateTrainingRegistarById(req: Request, res: Response): Promise<any>{
    ...
    const trainingRegistar = await updateTrainingRegistarByIdQuery(trainingRegistarId,updatedTrainingRegistar,transaction);
...
export async function deleteTrainingRegistarById(req: Request, res: Response): Promise<any>{
    ...
    try{
        ...
        const deleteTrainingRegistar = await deleteTrainingRegistarByIdQuery(trainingRegistarId,transaction);
