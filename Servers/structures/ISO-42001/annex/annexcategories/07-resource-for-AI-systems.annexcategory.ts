...
export const ResourcesForAISystems: Partial<AnnexCategoryStructISO & AnnexCategoryISO>[] = [
  {
    ...
    is_applicable: true,
    implementation_description: "Comprehensive resource inventory including computing power, datasets, and personnel established.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Lifecycle management of computational resources enforced via IT asset management policies.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "Data resource usage and availability are regularly monitored and documented.",
  ...
  },
  {
    ...
    is_applicable: false,
    "justification_for_exclusion": "Legacy systems used do not support detailed resource lifecycle management.",
  ...
  },
  {
    ...
    is_applicable: true,
    implementation_description: "AI staffing includes dedicated roles with competency development plans.",
